...
class VendorProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            ...
            $deleteBtn = "<a href='".route('vendor.products.destroy', $query->id)."' class='btn btn-danger ml-10 delete-item'><i class='far fa-trash-alt'></i></a>";
            $moreBtn = '<div class="btn-group dropstart" style="margin-left:3px">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item has-icon" href="'. route('admin.products-variant.index', ['product' => $query->id]) .'"><i class="far fa-file"></i> Variants</a></li>                                                
                    </ul>
                    </div>';
        ...
        ->addColumn('type', function($query){
            switch ($query->product_type) {
                ...
                case 'top_product':
                    return '<i class="badge bg-danger">Top Prodcut</i>';
                default:
