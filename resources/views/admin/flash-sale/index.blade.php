                        ...
                        <div class="card-body">
                            <form action="{{route('admin.flash-sale.add-product')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product" value="" id="" class="form-control select2">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="show_at_home" value="" id="" class="form-control">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select name="status" value="" id="" class="form-control">
                                                <option value="">Select</option>
